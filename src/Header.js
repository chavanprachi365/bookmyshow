                        ...
                        <div className="col-12 col-md-7 ">
                            <div className="row align-item center">
                                ...
                                <div className="col-12 col-md-9 mt-3">
                                    ...
                                    <input type="text" className=" border-0 w-100  p-1 px-2  " placeholder="search for movies, events, plays,   sports & activities" />
                        ...
                        <div  className="col-12 col-md-3">
                            <div className="row align-items-center  text-end justify-content-end">
                                <div className="col-12 col-md-7 d-flex justify-content-end gap-3 ">
                                    ...
                                    <button className=" b_bg_red_light_color text-white rounded-2 py-1 border-0 px-2">sign in </button>
                                </div>
